...
conn.sendFile(m.chat, video, title + '.mp4', `_${title}_\n_${quality}_`, m, false, { mimetype: 'video/mp4', asDocument: false })
await m.react('✅')
} catch {
try { 
await m.react('🕑')
...
conn.sendFile(m.chat, video, title + '.mp4', `_${title}_`.trim(), m, false, { mimetype: 'video/mp4', asDocument: false })
await m.react('✅')
} catch {
await m.react('❌')
}}}
