...
console.log('🚩 Nixie no tiene Sub-Bots vinculados.');
return;
}
...
console.log(chalk.bold.greenBright(`🚩 Nixie conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🍭 Error al iniciar Minie-Bot: `, error))
}
})();
